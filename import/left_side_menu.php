...
//총체력
$full_health;
if(!strcmp($_SESSION['permission'],'hycube')){
  $full_health=200+($userdata['level']-1)*20;
}
else if(!strcmp($_SESSION['permission'],'normal')){
  $full_health=150+($userdata['level']-1)*10;
}
else if(!strcmp($_SESSION['permission'],'operator')){
  ...
  <div class="left_col scroll-view">
    ...
    <div class="profile clearfix">
      <div class="profile_pic">
        ...
        <span class="image_badge bg-green"><?php echo $userdata['level'];?></span>
      ...
      <div class="profile_info">
        ...
        <div href="#" data-toggle="tooltip" data-placement="bottom" title="다음 레벨까지 : <?php echo $_SESSION['EXP'];?>/<?php echo 100*$userdata['level'];?>">
          <div class="progress progress_sm" style="width: 100%;">
            <div class="progress-bar bg-yellow" role="progressbar" data-transitiongoal="<?php echo $userEXP/$userdata['level'];?>"></div>
          </div>
        </div>
        <?php }?>
      </div>
