...
function do_signup(){
    ...
    xmlhttp.open("POST", "/choi/require.php", true);
...
function do_login() {
    ...
    formData.append("password",pw);
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("POST", "/choi/check_account.php", true);
    xmlhttp.send(formData);
    xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            if(this.responseText=="success"){
...
function do_logout() {
    console.log("logout");
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("POST", "/choi/logout.php", true);
    xmlhttp.send();
    xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            if(this.responseText=="success"){
...
function send_mail(email) {
    ...
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("POST", "/choi/send.php", true);
    xmlhttp.send(formData);
    xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            if(this.responseText=="success"){
